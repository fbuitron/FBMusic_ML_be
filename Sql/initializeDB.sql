...
CREATE TABLE `AudioFeatures` (
  ...
  `acousticness` decimal(18,6) DEFAULT NULL,
  `danceability` decimal(18,6) DEFAULT NULL,
  `duration_ms` bigint DEFAULT NULL,
  `energy` decimal(18,6) DEFAULT NULL,
  `instrumentalness` decimal(18,6) DEFAULT NULL,
  `a_key` smallint DEFAULT NULL,
  `liveness` decimal(18,6) DEFAULT NULL,
  `loudness` decimal(18,6) DEFAULT NULL,
  `a_mode` smallint DEFAULT NULL,
  `speechiness` decimal(18,6) DEFAULT NULL,
  `tempo` decimal(18,6) DEFAULT NULL,
  `time_signature` smallint DEFAULT NULL,
  `valence` decimal(18,6) DEFAULT NULL,
  PRIMARY KEY (`ID`),
